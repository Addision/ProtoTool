...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.WidMsgTree.setGeometry(QtCore.QRect(10, 60, 491, 661))
        font = QtGui.QFont()
        ...
        self.BtnAdd.setGeometry(QtCore.QRect(520, 110, 81, 41))
        self.BtnAdd.setObjectName("BtnAdd")
        self.BtnDel = QtWidgets.QPushButton(self.centralwidget)
        self.BtnDel.setGeometry(QtCore.QRect(520, 210, 81, 41))
        self.BtnDel.setObjectName("BtnDel")
        self.BtnUpdate = QtWidgets.QPushButton(self.centralwidget)
        self.BtnUpdate.setGeometry(QtCore.QRect(520, 310, 81, 41))
        self.BtnUpdate.setObjectName("BtnUpdate")
        self.BtnSave = QtWidgets.QPushButton(self.centralwidget)
        self.BtnSave.setGeometry(QtCore.QRect(520, 410, 81, 41))
        self.BtnSave.setObjectName("BtnSave")
        self.FrameMsg_2 = QtWidgets.QFrame(self.centralwidget)
        self.FrameMsg_2.setGeometry(QtCore.QRect(10, 0, 491, 51))
        self.FrameMsg_2.setFrameShape(QtWidgets.QFrame.Box)
        self.FrameMsg_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.FrameMsg_2.setObjectName("FrameMsg_2")
        self.label_6 = QtWidgets.QLabel(self.FrameMsg_2)
        self.label_6.setGeometry(QtCore.QRect(10, 10, 51, 21))
        self.label_6.setObjectName("label_6")
        self.LetModName = QtWidgets.QLineEdit(self.FrameMsg_2)
        self.LetModName.setGeometry(QtCore.QRect(70, 10, 111, 31))
        self.LetModName.setObjectName("LetModName")
        self.label_7 = QtWidgets.QLabel(self.FrameMsg_2)
        self.label_7.setGeometry(QtCore.QRect(190, 10, 61, 21))
        self.label_7.setObjectName("label_7")
        self.LetModCmt = QtWidgets.QLineEdit(self.FrameMsg_2)
        self.LetModCmt.setGeometry(QtCore.QRect(240, 10, 161, 31))
        self.LetModCmt.setObjectName("LetModCmt")
        self.BtnModAdd = QtWidgets.QPushButton(self.FrameMsg_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BtnMsgAdd.setText(_translate("MainWindow", "ADD"))
        ...
        self.BtnModAdd.setText(_translate("MainWindow", "ADD"))
        ...
        self.BtnFieldAdd.setText(_translate("MainWindow", "ADD"))

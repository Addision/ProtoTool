...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CbxValueMod.setItemText(0, _translate("MainWindow", "int32"))
        self.CbxValueMod.setItemText(1, _translate("MainWindow", "int64"))
        self.CbxValueMod.setItemText(2, _translate("MainWindow", "string"))
        self.CbxValueMod.setItemText(3, _translate("MainWindow", "float"))
        self.CbxValueMod.setItemText(4, _translate("MainWindow", "double"))
        self.CbxValueMod.setItemText(5, _translate("MainWindow", "bytes"))
        self.CbxValueMod.setItemText(6, _translate("MainWindow", "bool"))
        self.CbxValueMod.setItemText(7, _translate("MainWindow", "uint32"))
        self.CbxValueMod.setItemText(8, _translate("MainWindow", "uint64"))
